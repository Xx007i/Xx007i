(window.Modernizr = (function(e, t, n) {
    ...
    function u() {
        (m.input = (function(n) {
            ...
            return (
                M.list &&
                (M.list = !!t.createElement("datalist") && !!e.HTMLDataListElement),
                M
            );
        })(
    ...
    var f,
        ...
        D = {}.hasOwnProperty;
    (d =
        a(D, "undefined") || a(D.call, "undefined") ?
        function(e, t) {
    ...
    for (var F in N)
        d(N, F) &&
        ((f = F.toLowerCase()), (m[f] = N[F]()), A.push((m[f] ? "" : "no-") + f));
    return (
        m.input || u(),
